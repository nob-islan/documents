import{_ as a,o as i,c as n,a6 as e}from"./chunks/framework.C3mgXFrM.js";const c=JSON.parse('{"title":"DockerでHAProxyを構築","description":"","frontmatter":{},"headers":[],"relativePath":"docker/examples/DockerでHAProxyを構築.md","filePath":"docker/examples/DockerでHAProxyを構築.md"}'),l={name:"docker/examples/DockerでHAProxyを構築.md"};function p(t,s,h,r,k,o){return i(),n("div",null,[...s[0]||(s[0]=[e(`<h1 id="dockerでhaproxyを構築" tabindex="-1">DockerでHAProxyを構築 <a class="header-anchor" href="#dockerでhaproxyを構築" aria-label="Permalink to “DockerでHAProxyを構築”">​</a></h1><p>cf. <a href="https://www.haproxy.com/documentation/haproxy-configuration-tutorials/" target="_blank" rel="noreferrer">https://www.haproxy.com/documentation/haproxy-configuration-tutorials/</a></p><ul><li><code>docker-compose.yaml</code>を下記で作成します:</li></ul><div class="language-yaml"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">services</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
