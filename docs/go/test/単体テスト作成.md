...
func (m *mockUsersRepository) FindByName(q query.FindByNameQuery) domain.Users {
	args := m.Called(q)
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(mock *mockUsersRepository) {
				mock.On("FindByName", query.NewFindByNameQuery("nob")).Return(
