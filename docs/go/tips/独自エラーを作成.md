...
func ToHttpErrorResponse(err error) (int, any) {
	...
	case EasyappBusinessError:
		return http.StatusUnprocessableEntity, easyappBusinessErrorResponse{Message: e.message}
	default:
...
func (u *userUsecase) Login(ctx context.Context, in params.LoginInput) (params.LoginOutput, error) {
	...
	if user.Name() == "" {
		return params.LoginOutput{}, apperrors.NewEasyappBusinessError("user not found")
	}
