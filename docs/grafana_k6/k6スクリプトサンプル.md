...
export default function () {
  const res = http.get("http://host.docker.internal:8080/api/v1/user?name=nob");
...
export default function () {
  http.get("http://host.docker.internal:8080/api/v1/user?name=nob");
}
```
...
export default function () {
  ...
  const res = http.get(
    "http://host.docker.internal:8080/api/v1/user" +
      "?name=" +
