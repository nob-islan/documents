...
+     GreetResponse greet(@ParameterObject GreetRequest greetRequest);
       ...
       */
      @PostMapping(value = "/user")
+     @Operation(summary = "ユーザ情報の登録", description = "${easyappdoc.describe.api.v1.user:説明文}") // TODO
+     @ApiResponses(value = {
+             @ApiResponse(responseCode = "200", description = "正常に処理された場合"),
...
```diff
   ...
   */
  @Value
+ @Schema(description = "挨拶APIのリクエストモデル", type = "object") // TODO
  public class GreetRequest {

    /** ユーザ名 */
+     @Schema(description = "ユーザ名", type = "string", example = "nob") // TODO
      private String name;
  }
```
...
```diff
   ...
   */
  @Value
+ @Schema(description = "挨拶APIのレスポンスモデル", type = "object") // TODO
  public class GreetResponse {

      /** 挨拶メッセージ */
+     @Schema(description = "挨拶メッセージ", type = "string", example = "Hello, nob!") // TODO
      private String message;
  }
```
...
```diff
  ...
  */
  @Value
+ @Schema(description = "登録APIのリクエストモデル", type = "object") // TODO
...
+     @Schema(description = "ユーザ名", type = "string", example = "nob") // TODO
      ...
      /** 年齢 */
+     @Schema(description = "年齢", type = "integer", example = "13") // TODO
      private Integer age;
  }
```
...
```diff
  ...
  */
  @Value
+ @Schema(description = "登録APIのレスポンスモデル", type = "object") // TODO
  public class RegistResponse {

      /** 登録メッセージ */
+     @Schema(description = "登録メッセージ", type = "string", example = "登録が完了しました。") // TODO
      private String message;
  }
```
