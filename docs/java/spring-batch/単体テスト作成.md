...
`test/resources/customerregist`配下にテストデータ投入向けのSQLを用意します:
...
@TestPropertySource(properties = {
        "spring.sql.init.schema-locations=classpath:/customerregist/schema.sql",
        "spring.sql.init.data-locations=classpath:/customerregist/data.sql"
})
public class CustomerRegistTest {
    ...
    public void test() throws Exception {
        ...
        assertThat(customerList)
                ...
                .containsExactly(
                        new Customer(1, "snailnob01", 13),
                        new Customer(2, "snailnob02", 14));
    }
}
```
