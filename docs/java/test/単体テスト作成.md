...
public class AuthControllerTest {
    ...
    void testGetUserSuccess() {
        ...
        try {
            ...
            // 結果のassert
            assertThat(result.getResponse().getContentAsString())
                    .isEqualTo(objectMapper.writeValueAsString(new GetUserResponse("nob", 13)));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
...
public class AuthServiceImplTest {
    ...
    void testUserSuccess() {
        ...
        // 入力値の作成
        GetUserInModel inModel = new GetUserInModel("nob");
        ...
        // service呼び出し
        GetUserOutModel outModel = authService.getUser(inModel);
        // 結果のassert
        assertThat(outModel).usingRecursiveAssertion().isEqualTo(new GetUserOutModel("nob", 13));
    }
}
```
