...
public class AuthControllerTest {
    ...
    void testUserSuccess() {
        ...
        try {
            ...
            // 結果のassert
            assertThat(result.getResponse().getContentAsString())
                    .isEqualTo(objectMapper.writeValueAsString(new UserResponse("nob", 13)));
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
...
public class AuthServiceImplTest {
    ...
    void testUserSuccess() {
        ...
        // 入力値の作成
        UserInModel inModel = new UserInModel("nob");
        ...
        // service呼び出し
        UserOutModel outModel = authService.user(inModel);
        // 結果のassert
        assertThat(outModel).usingRecursiveAssertion().isEqualTo(new UserOutModel("nob", 13));
    }
}
```
