...
public class MethodArgumentNotValidExceptionHandler {
    ...
    public ResponseEntity<MethodArgumentNotValidExceptionResponseBody> validatorExceptionHandle(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new MethodArgumentNotValidExceptionResponseBody(messageList));
    }
     ...
     */
    public record MethodArgumentNotValidExceptionResponseBody(List<String> messageList) {
    }
}
```
        ...
        try {
            ...
            assertThat(result.getResponse().getContentAsString())
                    .isEqualTo(objectMapper.writeValueAsString(
                            new MethodArgumentNotValidExceptionHandler.MethodArgumentNotValidExceptionResponseBody(
